...
# Get wallpapers
wget -O ~/.config/wallpaper/wallpaper.jpg https://www.hexxedbitheadz.com/wp-content/uploads/go-x/u/f67880cf-4b26-4a6d-b6ef-8803d9901307/image.jpg && wget -O ~/.config/wallpaper/lockscreen.png https://www.hexxedbitheadz.com/wp-content/uploads/go-x/u/83622957-3d01-47fc-9f83-80b5610246cf/image.png
...
sed -i 's/foreground = #C5C8C6/foreground = #e3f3f6/g' ~/.config/polybar/config.ini
sed -i 's/primary = #F0C674/primary = #5c2ac5/g' ~/.config/polybar/config.ini
sed -i 's/secondary = #8ABEB7/secondary = #000000/g' ~/.config/polybar/config.ini
sed -i '/disabled =/a cancelButton = #5c2ac5' ~/.config/polybar/config.ini
...
sed -i 's/label-connected = %{F#F0C674}%ifname%%{F-} %essid% %local_ip%/label-connected = %{F#5c2ac5}%ifname%%{F-} %essid% %local_ip%/g' ~/.config/polybar/config.ini

sed -i 's/%{F#F0C674}%ifname%%{F-} %local_ip%/%{F#5c2ac5}%ifname%%{F-} %local_ip%/g' ~/.config/polybar/config.ini
...
/\[urgency_normal\]/,/timeout = 10/ { s/background = "#285577"/background = "#87d63c"/; s/foreground = "#ffffff"/foreground = "#0c75a0"/; s/timeout = 10/timeout = 10/; s/#default_icon = \/path\/to\/icon/#default_icon = \/path\/to\/icon/; s/\[urgency_normal\]/\[urgency_normal\]\n    frame_color = "#0c75a0"/; }
/\[urgency_critical\]/,/timeout = 0/ { s/background = "#900000"/background = "#ffffff"/; s/foreground = "#ffffff"/foreground = "#5c2ac5"/; s/frame_color = "#ff0000"/frame_color = "#5c2ac5"/; s/timeout = 0/timeout = 0/; s/#default_icon = \/path\/to\/icon/#default_icon = \/path\/to\/icon/; }' ~/.config/dunst/dunstrc
